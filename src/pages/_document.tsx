  ...
  return (
    <Html lang="ja">
      <Head>
        ...
        <meta property="og:image" content="https://artist-map.kgetheshadowmen.com/og.png" />
        <meta property="og:locale" content="ja_JP" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:description" content="ラッパーやDJなど国内のHIPHOPアーティストが経営する店舗を日本の地図上で可視化しました。これを見ることにより具体的な場所や、関連する情報を知ることができます。" />
        <meta name="twitter:image:src" content="https://artist-map.kgetheshadowmen.com/og.png" />
      </Head>
      <body>
        <Main />
        <NextScript />
